...
#
# Do not push this much below ~0.5m: the tag has to be detectable from here or
# the search sweep runs on every dock. At 60cm the 80mm tag subtends ~90px,
# comfortably above the ~40px where decoding gets marginal.
_STAGING_STANDOFF_M = 0.60
