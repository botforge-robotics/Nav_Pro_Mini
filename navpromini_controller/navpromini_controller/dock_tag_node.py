...
class DockTagNode(Node):
    def __init__(self) -> None:
        ...
        # camera_node being inactive already means no images arrive here, but
        # this stops any stray/retained frame from being processed too, and
        # keeps dock_tag from publishing stale-looking data outside a dock
        # attempt.
        self._active = False
        ...
        self.get_logger().info(
            f'dock_tag ready: looking for AprilTag 36h11 id={self._want_id}, '
            f'{self._tag_size * 1000:.0f}mm — inactive until dock_tag/set_active(true)'
        )
